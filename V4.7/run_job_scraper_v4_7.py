...
# ============================================================
# V4.7 BRUSSELS 30 KM LOCATION INTELLIGENCE
# ============================================================
...
# Unknown locations are reported, never rejected in V4.7.
...
# ============================================================
# V4.7 VACANCY IDENTITY / CONSERVATIVE DEDUPLICATION
# ============================================================
...
def conservative_deduplicate_dataframe(df):
    ...
    print(
        f"V4.7 conservative dedup removed {removed} proven duplicate representation(s)."
    )
    print(
...
def run():
    ...
    print()
    print("=" * 50)
    print("JOB SEARCHING AGENT V4.7 - BRUSSELS 30KM LOCATION INTELLIGENCE")
    print("=" * 50)
    ...
    # V4.7 conservative vacancy identity:
    ...
    print()
    print("=" * 50)
    print("V4.7 LOCATION INTELLIGENCE")
    print("=" * 50)
    ...
    print("REPORT-ONLY: OUTSIDE_30KM jobs are NOT rejected in V4.7.")
