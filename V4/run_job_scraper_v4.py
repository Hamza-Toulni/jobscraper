...
SOURCES = [
    ...
    {"company":"Infrabel","url":"https://jobs.infrabel.be/go/Alle-vacatures/957602/","domain":"jobs.infrabel.be","type":"generic","job_url_regex":r"/job/[^/]+/\\d+/"},
    {"company":"HR Rail","url":"https://jobs.infrabel.be/HRRail/go/Tous-les-vacatures-HR-Rail/957302/","domain":"jobs.infrabel.be","type":"generic","job_url_regex":r"/job/[^/]+/\\d+/"},
    {"company":"Sopra Steria","url":"https://careers.soprasteria.be/jobs","domain":"careers.soprasteria.be","type":"generic","job_url_regex":r"/job/[^/]+-jid-\\d+"},
    {"company":"Keyrus","url":"https://jobs.keyrus.be/jobs","domain":"jobs.keyrus.be","type":"generic","job_url_regex":r"/jobs/\\d+-[^/]+"},
    {"company":"Datashift","url":"https://careers.datashift.eu/jobs","domain":"careers.datashift.eu","type":"generic","job_url_regex":r"/jobs/\\d+-[^/]+"},
    {"company":"Sibelga","url":"https://jobs.sibelga.be/offre-de-emploi/liste-toutes-offres.aspx?mode=list","domain":"jobs.sibelga.be","type":"generic","job_url_regex":r"/offre-de-emploi/[^?]+"},
    {"company":"LACO","url":"https://www.laco.be/vacancy/","domain":"laco.be","type":"generic","job_url_regex":r"/vacancy/[^/]+/?$"},
]
...
def discover(source):
    ...
    if source_type == "generic":
        return discover_generic(source)
...
def run():
    ...
    print()
    print("=" * 50)
    print("JOB SEARCHING AGENT V4.0 - MULTI-SOURCE ARCHITECTURE")
    print("=" * 50)
    ...
    for company, targets, ok_count, rejected_count in source_health:
        status = "OK" if targets > 0 else "CHECK"
        print(f"{status:5} | {company:<22} | targets={targets} | accepted={ok_count} | rejected={rejected_count}")
