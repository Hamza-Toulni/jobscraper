...
def discover_cegeka(source):
    print("  strategy: Cegeka listing + indexed-job fallback")
    ...
    queries = [
        ...
        'site:cegeka.com/en/be/jobs/all-jobs/ "Data Migration"',
    ]

    for query in queries:
        try:
            for url, title in search_discovery(
                query, domains=["cegeka.com"], max_results=15
            ):
            ...
            print("  Cegeka indexed discovery skipped:", exc)
...
def run():
    ...
    print()
    print("=" * 50)
    print("JOB SCRAPER V3.1 - RELIABILITY VERSION")
    print("=" * 50)
